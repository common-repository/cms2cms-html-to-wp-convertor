...
class CmsPluginFunctionsHtml
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"  : "//wordpress.org/support/plugin/cms2cms-html-to-wp-convertor/reviews",
    ...
    {
        $cms2cms_html_access_login = get_option('cms2cms-html-login');
        $cms2cms_html_access_key   = get_option('cms2cms-html-key');
    ...
    {
        $key   = get_option('cms2cms-html-key');
        $login = get_option('cms2cms-html-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-html-key', $key);

            delete_option('cms2cms-html-login');
            add_option('cms2cms-html-login', $login);

            delete_option('cms2cms-html-depth');
            add_option('cms2cms-html-depth', $bridge_depth);
